...
import { playerTokenFrom, pvpUnready, SolcoreError } from '@/lib/solcore';

// Bereit-Haken wieder entfernen — wallet-gebundene Aktion.
export async function POST(req: Request, { params }: { params: { id: string } }) {
  try {
    ...
    return NextResponse.json(await pvpUnready(params.id, { playerWallet: body.playerWallet }, playerTokenFrom(req)));
  } catch (err) {
